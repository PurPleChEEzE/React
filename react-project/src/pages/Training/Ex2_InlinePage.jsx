        ...
        <body>
            ...
            <table style={{
                ...
                <tbody>
                    ...
                    <tr>
                        <td style={{ border: "1px solid black", backgroundColor: "aliceblue" }}>2023-09-22</td>
                        <td style={{ border: "1px solid black", backgroundColor: "aliceblue", color: "red" }}>+1,000,000원</td>
                        <td style={{ border: "1px solid black", backgroundColor: "aliceblue" }}>월급</td>
                        <td style={{ border: "1px solid black", backgroundColor: "aliceblue", color: "blue" }}>-250,000원</td>
                        <td style={{ border: "1px solid black", backgroundColor: "aliceblue" }}>카드값</td>
                    </tr>
                    <tr>
                        <td colSpan="5" style={{ border: "1px solid black", backgroundColor: "aliceblue" }}><strong>남은 금액 : 590,000원</strong></td>
                    </tr>
                </tbody >
            </table >
            <BackButton />
